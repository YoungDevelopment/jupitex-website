...
export function KineticText({
  ...
  return (
    <Tag
      {...rest}
      className={cn("font-[300] text-center inline-block", className)}
      style={mergedStyle}
    >
